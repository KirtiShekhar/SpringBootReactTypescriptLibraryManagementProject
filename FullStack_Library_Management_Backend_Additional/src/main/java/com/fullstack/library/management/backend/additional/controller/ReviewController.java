...
public class ReviewController
{
    ...
    public ResponseEntity<?> saveBookReview(@RequestHeader(value = "Authorization") String jwtToken,
                                            @RequestBody ReviewRequestDto reviewRequestDto) throws EmailMissingException
    {
    ...
    public ResponseEntity<?> isBookCheckedOutByUser(@RequestHeader(name = "Authorization") String jwtToken,
