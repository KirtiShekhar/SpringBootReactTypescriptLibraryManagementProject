...
public class CheckOutController
{
    ...
    public ResponseEntity<?> checkOutBook(@RequestHeader(value = "Authorization") String jwtToken,
                                          @RequestParam Long bookId) throws EmailMissingException
    {
    ...
    public ResponseEntity<?> currentLoansCount(@RequestHeader(value = "Authorization") String jwtToken) throws EmailMissingException
    {
        String userEmail = ExtractJWT.payloadJWTExtraction(jwtToken,"\"emailAddress\"");
        if(userEmail == null)
        {
    ...
    public ResponseEntity<?> currentLoans(@RequestHeader(value = "Authorization") String jwtToken) throws EmailMissingException, ParseException {
        String userEmail = ExtractJWT.payloadJWTExtraction(jwtToken,"\"emailAddress\"");
        if(userEmail == null)
        {
            throw new EmailMissingException("userEmail is missing");
