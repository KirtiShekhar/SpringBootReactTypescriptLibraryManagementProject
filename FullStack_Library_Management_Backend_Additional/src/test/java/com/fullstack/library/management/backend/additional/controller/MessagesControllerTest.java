...
public class MessagesControllerTest extends mockData
{
    ...
    void getMessagesByUserPageWisePositiveTest() throws Exception
    {
        ...
        ResponseMessages<Page<Messages>> messagePageWisePositiveResponseMessage = new ResponseMessages<>();
        messagePageWisePositiveResponseMessage.setData(messagesListPageWisePositive);
        when(messagesService.findMessagesByUserPageWise(userEmail,0,5)).thenReturn(messagePageWisePositiveResponseMessage);
        ...
        getAllMessagesByUserPageWisePositiveResult
                ...
                .andExpect(jsonPath("$.data.totalElements",is((int) messagesListPageWisePositive.getTotalElements())));
    }
    ...
    void getMessagesByUserPageWiseNegativeTest() throws Exception
    {
        ...
        ResponseMessages<Page<Messages>> messagePageWiseNegativeResponseMessage = new ResponseMessages<>();
        messagePageWiseNegativeResponseMessage.setData(messagesListPageWiseNegative);
        when(messagesService.findMessagesByUserPageWise(userEmail,0,5)).thenReturn(messagePageWiseNegativeResponseMessage);
        ...
        getAllMessagesByUserPageWiseNegativeResult
                ...
                .andExpect(jsonPath("$.data.totalElements",is((int) messagesListPageWiseNegative.getTotalElements())));
    }
    ...
    void getMessagesByClosedPageWisePositiveTest() throws Exception
    {
        ...
        ResponseMessages<Page<Messages>> messageClosedPageWisePositiveResponseMessage = new ResponseMessages<>();
        messageClosedPageWisePositiveResponseMessage.setData(messagesListPageWisePositive);
        when(messagesService.findMessagesByClosedPageWise(true,0,5)).thenReturn(messageClosedPageWisePositiveResponseMessage);
    ...
    void getMessagesByClosedPageWiseNegativeTest() throws Exception
    {
        ...
        ResponseMessages<Page<Messages>> messageClosedPageWiseNegativeResponseMessage = new ResponseMessages<>();
        messageClosedPageWiseNegativeResponseMessage.setData(messagesListPageWiseNegative);
        when(messagesService.findMessagesByClosedPageWise(false,0,5)).thenReturn(messageClosedPageWiseNegativeResponseMessage);
