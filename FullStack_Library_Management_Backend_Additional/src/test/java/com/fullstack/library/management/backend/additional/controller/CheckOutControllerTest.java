...
public class CheckOutControllerTest extends mockData
{
    ...
    void checkOutGivenBookForGivenUserPositiveTest() throws Exception
    {
        ...
        when(checkOutService.checkOutBook(userEmail,bookId)).thenReturn(bookIdPositiveResponseMessage);
        ...
        // event
        checkOutBookPositiveResult.andExpect(jsonPath("$.data").hasJsonPath());
    }
    ...
    void getAllCheckOutDetailsPositiveTest() throws Exception
    {
        ...
        checkOutListResponseMessages.setData(mockCheckOutDataListPositiveData());
        when(checkOutService.getAllCheckOutDetails()).thenReturn(checkOutListResponseMessages);
        ...
        // event
        getAllCheckOutPositiveResult.andExpect(jsonPath("$.data").isNotEmpty())
    ...
    void getAllCheckOutDetailsNegativeTest() throws Exception
    {
        ...
        ResponseMessages<List<CheckOut>> checkOutListNegativeResponseMessages = new ResponseMessages<>();
        checkOutListNegativeResponseMessages.setData(mockCheckOutDataListNegativeData());
        when(checkOutService.getAllCheckOutDetails()).thenReturn(checkOutListNegativeResponseMessages);
        ...
        // event
        getAllCheckOutNegativeResult.andExpect(jsonPath("$.data.size()",is(mockCheckOutDataListNegativeData().size())))
                .andExpect(jsonPath("$.data",hasSize(greaterThanOrEqualTo(0))));
    }
    ...
    void getAllCheckOutDetailsPageWisePositiveTest() throws Exception
    {
        ...
        ResponseMessages<Page<CheckOut>> checkOutPageWisePositiveResponseMessages = new ResponseMessages<>();
        checkOutPageWisePositiveResponseMessages.setData(checkOutListPageWisePositive);
        when(checkOutService.getAllCheckoutDetailsPageWise(0,5)).thenReturn(checkOutPageWisePositiveResponseMessages);
        // context
        ...
        getAllCHeckOutDetailsPageWisePositiveResult
                ...
                .andExpect(jsonPath("$.data.size()",is(11)))
                .andExpect(jsonPath("$.data.totalElements",is((int) checkOutListPageWisePositive.getTotalElements())));
    }
    ...
    void getAllCheckOutDetailsPageWiseNegativeTest() throws Exception
    {
        ...
        ResponseMessages<Page<CheckOut>> checkOutPageWiseNegativeResponseMessages = new ResponseMessages<>();
        checkOutPageWiseNegativeResponseMessages.setData(checkOutListPageWiseNegative);
        when(checkOutService.getAllCheckoutDetailsPageWise(0,5)).thenReturn(checkOutPageWiseNegativeResponseMessages);
        // context
        ...
        getAllCHeckOutDetailsPageWiseNegativeResult
                ...
                .andExpect(jsonPath("$.data.totalElements",is((int) checkOutListPageWiseNegative.getTotalElements())));
    }
    ...
    void getAllCheckOutByCheckOutIdPositiveTest() throws Exception
    {
        ...
        ResponseMessages<CheckOut> checkOutIdPositiveResponseMessages = new ResponseMessages<>();
        checkOutIdPositiveResponseMessages.setData(mockCheckOutData());
        when(checkOutService.getCheckOutDetailsByCheckOutId(checkoutId)).thenReturn(checkOutIdPositiveResponseMessages);
        //
        // context
        ...
        // event
        getCheckOutDetailsByCheckOutIdPositiveResult.andExpect(jsonPath("$.data").isNotEmpty());
    }
    ...
    void currentLoansPositiveTest() throws Exception
    {
        ...
        shelfCurrentLoansListResponseMessages.setData(mockShelfCurrentLoansResponseListPositiveData());
        when(checkOutService.currentLoans(userEmail)).thenReturn(shelfCurrentLoansListResponseMessages);
        // context
        ...
        // event
        userCurrentLoansPositiveResult.andExpect(jsonPath("$.data").isNotEmpty())
                .andExpect(jsonPath("$.data.size()",is((int) mockShelfCurrentLoansResponseListPositiveData().size())));
    }
