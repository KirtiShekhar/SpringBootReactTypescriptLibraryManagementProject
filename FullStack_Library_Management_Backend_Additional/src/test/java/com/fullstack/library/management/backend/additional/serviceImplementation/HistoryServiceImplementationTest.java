...
public class HistoryServiceImplementationTest extends mockData
{
    ...
    void getAllHistoryPositiveTest()
    {
        ...
        // event
        ResponseMessages<List<History>> savedHistory = historyServiceImplementation.getAllHistory();
        // outcome
        assertNotNull(savedHistory.getData());
    }
    ...
    void getAllHistoryForGivenUserPageWisePositiveTest()
    {
        ...
        // event
        ResponseMessages<Page<History>> historyPageWise = historyServiceImplementation.getBookCheckOutHistoryForUserPageWise(mockHistoryData().getUserEmail(),0,5);
        // outcome
        assertEquals(mockHistoryPage.getTotalElements(),historyPageWise.getData().getTotalElements());
    }
    ...
    void getAllHistoryForGivenUserPageWiseNegativeTest()
    {
        ...
        // event
        ResponseMessages<Page<History>> historyPageWise = historyServiceImplementation.getBookCheckOutHistoryForUserPageWise("kirtishekhar19@gmail.com",0,5);
        // outcome
