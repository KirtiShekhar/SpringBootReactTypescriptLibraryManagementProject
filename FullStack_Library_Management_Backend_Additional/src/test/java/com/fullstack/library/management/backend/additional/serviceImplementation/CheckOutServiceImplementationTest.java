...
public class CheckOutServiceImplementationTest extends mockData
{
    ...
    void getAllCheckOutDetailsPositiveTest()
    {
        ...
        // event
        ResponseMessages<List<CheckOut>> savedCheckOutDetailsList = checkOutServiceImplementation.getAllCheckOutDetails();
        // outcome
    ...
    void getAllCheckOutDetailsNegativeTest()
    {
        ...
        ResponseMessages<List<CheckOut>> savedCheckOutDetailsList = checkOutServiceImplementation.getAllCheckOutDetails();
        // outcome
        assertNotEquals(savedCheckOutDetailsList.getData().size(),2);
    }
    ...
    void getAllCheckOutDetailsPageWisePositiveTest()
    {
        ...
        // event
        ResponseMessages<Page<CheckOut>> checkOutDetailsPageWise = checkOutServiceImplementation.getAllCheckoutDetailsPageWise(0,5);
        // outcome
        assertEquals(mockCheckOutPage.getTotalElements(),checkOutDetailsPageWise.getData().getTotalElements());
    }
    ...
    void getAllCheckOutByCheckOutIdPositiveTest()
    {
        ...
        // event
        ResponseMessages<CheckOut> checkOut = checkOutServiceImplementation.getCheckOutDetailsByCheckOutId(anyLong());
        // outcome
        assertNotNull(checkOut.getData());
    }
    ...
    void getCheckOutByCheckOutIdNegativeTest()
    {
        ...
        ResponseMessages<CheckOut> checkOut = checkOutServiceImplementation.getCheckOutDetailsByCheckOutId(anyLong());
        // outcome
        assertNotSame(mockCheckOutData(),checkOut.getData());
    }
    ...
    void currentLoansPositiveTest() throws Exception
    {
        ...
        ResponseMessages<List<ShelfCurrentLoansResponseDto>> shelfCurrentLoansResponseDtoList = checkOutServiceImplementation.currentLoans(mockCheckOutData().getUserEmail());
        assertEquals(mockShelfCurrentLoansResponseListPositiveData().size(),shelfCurrentLoansResponseDtoList.getData().size());
    }
    ...
    void currentLoansNegativeTest() throws Exception
    {
        ...
        ResponseMessages<List<ShelfCurrentLoansResponseDto>> shelfCurrentLoansResponseDtoList = checkOutServiceImplementation.currentLoans("admin@gmail.com");
        assertNotSame(mockShelfCurrentLoansResponseListNegativeData(),shelfCurrentLoansResponseDtoList.getData());
    }
