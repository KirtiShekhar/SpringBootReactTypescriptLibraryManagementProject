...
public class MessagesServiceImplementationTest extends mockData
{
    ...
    void getMessagesByUserPageWisePositiveTest()
    {
        ...
        // event
        ResponseMessages<Page<Messages>> messagesPageWise = messagesServiceImplementation.findMessagesByUserPageWise("kirtishekhar1997@gmail.com",0,5);
        // outcome
        assertEquals(mockMessagesPage.getTotalElements(),messagesPageWise.getData().getTotalElements());
    }
    ...
    void getMessagesByUserPageWiseNegativeTest()
    {
        ...
        // event
        ResponseMessages<Page<Messages>> messagesPageWise = messagesServiceImplementation.findMessagesByUserPageWise("admin@gmail.com",0,5);
        // outcome
    ...
    void getMessagesByClosedPageWisePositiveTest()
    {
        ...
        // event
        ResponseMessages<Page<Messages>> messagesPageWise = messagesServiceImplementation.findMessagesByClosedPageWise(true,0,5);
        // outcome
        assertEquals(mockMessagesPage.getTotalElements(),messagesPageWise.getData().getTotalElements());
    }
    ...
    void getMessagesByClosedPageWiseNegativeTest()
    {
        ...
        // event
        ResponseMessages<Page<Messages>> messagesPageWise = messagesServiceImplementation.findMessagesByClosedPageWise(false,0,5);
        // outcome
